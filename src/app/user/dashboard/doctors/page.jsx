      ...
      <div className="relative z-10 px-6 py-4">
        ...
        <div className="mb-5">
          <div className="flex items-center gap-2 mb-1">
            <Stethoscope className="w-5 h-5 text-[#00A99D]" />
            <h1 className="text-xl font-bold bg-gradient-to-r from-[#013A63] to-[#00A99D] bg-clip-text text-transparent">
              Doctors Specialist
            </h1>
          </div>
          <p className="text-slate-500 text-sm ml-7">Connect with top medical experts</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 mb-5">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 rounded-full border border-slate-200 bg-white hover:bg-slate-50 transition text-sm font-medium text-slate-600"
          >
            ...
            {filteredDoctors.map((doctor) => (
              ...
              >
                ...
                <div className="relative h-44 overflow-hidden">
                  ...
                  <div className="absolute top-2 right-2 bg-white/90 backdrop-blur-sm px-2 py-0.5 rounded-full flex items-center gap-0.5 shadow-sm">
                ...
                <div className="p-3">
                  ...
                  {/* Extra Features - Larger Text */}
                  <div className="flex flex-wrap gap-1.5 mb-2">
                    <span className="inline-flex items-center gap-1 text-[11px] px-2 py-0.5 rounded-full bg-green-50 text-green-600">
                    ...
                    <span className="inline-flex items-center gap-1 text-[11px] px-2 py-0.5 rounded-full bg-purple-50 text-purple-600">
